...
**Core Idea**: English syntax = Sentence Components + 5 Basic Sentence Patterns + Clauses + Word Order Rules
Every English sentence, no matter how long or complex, follows this framework.
...
All simple sentences follow these 5 patterns. **Long sentences are built from these basic units.**
...
5. **S + V + O + C** (Subject + Verb + Object + Object Complement): We **make** him happy. (him = object, happy = complement)

**Attribute & Adverbial Usage**
...
- Position is flexible: can be at the beginning, middle, or end.
...
- Questions: auxiliary verb/be verb moves before the subject: You are happy → **Are** you happy?
...
1. **Simple Tenses**
   - **Simple Present**: habits, general truths, routines — do/does: I **get up** at 7.
...
3. **Perfect Tenses** (completed action affecting the present): have/has **done**; had **done** (past before past)
   - **Perfect Continuous** (action that has been ongoing): have/has **been doing**
...
Using **not**:
1. **Action verbs** → add **don't / doesn't / didn't** + base verb: I like it → I **don't like** it. He likes it → He **doesn't like** it.
2. **be verbs / modal verbs** (can/will/must) → add **not** directly: He is here → He **isn't** here. I can do it → I **can't** do it.

**Subjunctive Mood**

**Core**: Expresses unreality, hypothesis, regret, or suggestion.

1. **Present contrary to fact**: If + past tense → **would + base verb**: If I **were** you, I **would study** hard. (I am not you — purely hypothetical)
2. **Past contrary to fact**: If + had done → **would have + past participle**: If I **had** studied, I **would have** passed. (I didn't study — now I regret it)
...
Inversion: **Auxiliary / Be / Modal moves before the subject**

1. **Questions** are the most basic inversion: You are happy → **Are** you happy?
2. **Negative words at the start** trigger inversion: Never / Little / Hardly / Seldom / No sooner → **Never have I seen** him.
3. **Only + adverbial** at the start: **Only then did I realize** it.
4. **So / Neither inversion**: I like it. → **So do I.** I don't like it. → **Neither do I.**
...
**Forms**: to do (infinitive), doing (gerund/present participle), and done (past participle)
...
- **Independent Clause (Main Clause)**: Can stand alone as a complete sentence: She sings beautifully.

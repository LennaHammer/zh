---
layout: post
title: 用 Jekyll + Github Pages 搭建博客
published: false
date: 2025-01-03
---
...
帖子放在 `_posts` 目录，草稿在 `_drafts`。个人倾向于在笔记软件编辑好了再发布到博客。一篇博客仅仅包含一个小的话题。
...
github 可以创建不同的项目，放在不同的路径下面，注意设置首页地址也可以包含路径。

Jekyll 实现分页，编写分页模板 index.html


最后，测试一下 markdown 的功能。

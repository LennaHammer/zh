...
说明
- 来源 https://toeflv3.kmf.com/listen/partcorder
    - 有mp3，时间戳，字幕，正文。
- 注意检查本文笔记章节的内容（短语和句子）是出自后面的原文章节。
...
- Of course — 当然
- In that case — 那样的话
- because of the extremely high cost — 因为极高的成本
- If he were — 如果他是
- In addition, — 此外
- However, — 然而
- Even if — 即使
- especially when there is — 尤其当有
- Needless to say, — 不用说
- no matter how long it's cooked — 无论煮多久
- in some cases — 在某些情况下

**时间表达**
- **具体历史/事件时间**
	- On January 9, 1793, at ten o'clock in the morning — 1793年1月9日上午十点
	- in 1793 — 在1793年
	- in 1916 — 在1916年
	- in the late nineteenth century — 在十九世纪末
	- at the end of the last ice age — 在上个冰河时代末期
	- since the Middle Ages — 自中世纪以来
	- didn't start until 1918 — 直到1918年才开始
	- in 1549 — 在1549年
- **时长与周期**
	...
	- it took two weeks — 花了两周时间
	- by train for nearly 100 years — 乘火车将近100年
...
- **事物特征描述**
	- is full of — 充满
	- is certainly full of — 无疑充满
	- was filled with — 填满了
	- people who — 那些……的人
	- think of astronomers as — 认为天文学家是
	- known as — 被称为
	- looks like — 看起来像
	- you can see — 你可以看到
	- at the mercy of the winds — 任凭风的摆布
	- are easy to prepare — 容易准备
	- Many grains are as simple to cook as spaghetti. — 许多谷物煮起来和意大利面一样简单
	- all they can do is — 他们所能做的只是
	- remains the same — 保持不变
	- are different from — 与……不同
- **数量程度表达**
	- There's plenty of — 有大量的
	- a lot of — 很多
	- a number of — 许多
	- something like — 类似于 / 大约
	- Most people — 大多数人
	- Many people in the United States — 美国的许多人
	- many people — 许多人
	- is substantially hotter than — 比……热得多
	- is greater than — 大于
	- at 80 degrees centigrade — 在80摄氏度
- **位置距离描述**
	- a distance of about 260 miles — 大约260英里的距离
- **方式与手段**
	- without using dangerous chemicals — 不使用危险的化学品
	- by train — 乘火车
- **能力与状态**
	- be especially interested in — 对……特别感兴趣
	- are especially good at — 特别擅长
	- are unable to — 无法
	- have trouble sleeping at night — 晚上难以入睡
	- enables him to — 使他能够
	- allowed him to — 允许他

**课堂教学用语**
- **开场与引入**
	- Today I want to talk about — 今天我想谈谈
	- The first thing I'd like to point out is that — 我想指出的第一点是
	- I'd like to mention that — 我想提一下
	- The first is — 第一个是
	- As you know — 如你所知
	- first of all — 首先
	- This next sample that I'll pass around is — 我接下来要传给大家的样本是
	- most of you — 你们大多数人
	- As you've seen, — 如你所见
	- One of our main jobs is to — 我们的主要工作之一是
	- as you may know — 如你所知
	- As you remember, — 正如你所记得的
	- The next style of furniture design I'd like to discuss is Shaker furniture design. — 接下来我想讨论的家具设计风格是Shaker家具设计
- **任务与要求**
	- What you're supposed to do is — 你应该做的是
	- you're supposed to — 你应该
	- be sure to — 务必
	- make sure — 确保
	- have to — 必须
	- understand how to — 理解如何
	- be able to — 能够
	- told his students to — 告诉他的学生去
	- encourage all students to — 鼓励所有学生去
	- see if you can figure it out — 看看你能不能想出来
- **互动与展示**
	- tell me what — 告诉我
	- look at — 看
	- look around — 环顾四周
	- If there are no questions, — 如果没有问题的话
	- As these slides show, — 正如这些幻灯片所示
...
**观点表达**
- **客观论述**
	- It's interesting to note that — 有趣的是
	- Scientists claim that there is no danger of fire — 科学家声称没有火灾危险
	- A recent research study found that — 最近的一项研究发现
	- The basic idea is that — 基本思想是
	- The most frequent problem was proposing too broad a topic — 最常见的问题是提出的主题太宽泛
	- What happens when you do that is that — 当你那样做时，会发生的是
	- The best thing to do is — 最好的做法是
	- He felt that — 他觉得
	- What Stieglitz was trying to do in these photographs was — Stieglitz在这些照片中试图做的是
	- Stieglitz was the first person to — Stieglitz是第一个……的人
	- The most common way to observe the skies is to photograph them — 观测天空最常见的方式是拍摄它们
	- It was suggested that — 有人提出
	- They discovered that — 他们发现
	- Adding grains is one of the easiest ways. — 添加谷物是最简单的方法之一
	- Some experts believe that — 一些专家认为
	- find it interesting that — 觉得有趣的是
	- What's interesting about them is that — 关于它们有趣的是
	- The result is that — 结果是
	- What happens is that — 发生的情况是
	- What we don't know is whether early humans used what they had. — 我们不知道的是早期人类是否使用了他们所拥有的
- **主观态度**
	- I'm sure — 我确信
	- I hope — 我希望
	- I'd like to — 我想要
	...
	- decided that — 决定
	- hope to — 希望
	- is interested in improving their diet — 对改善饮食感兴趣
...
- pick up — 拿起 / 接（人）/ 学会
- receive from — 从……收到
- speed up / speeding up — 加速
- play a prominent role in — 在……中发挥了重要作用
- try to — 尝试
- began to — 开始
- raise money for — 为……筹款
- pay for its renovation — 支付翻新费用
...
- come up with some innovative solutions — 想出一些创新的解决方案
- blame the automobile for — 把……归咎于汽车
- are divided into — 被分为
- begin with — 从……开始
- belong to — 属于
- have a look at — 看一看
- we're trying to — 我们正在尝试
- put together — 组装 / 整理
- participated in — 参加
- refused to — 拒绝
- give it back — 归还
...
**名词短语**
- the question of what photography is — 摄影是什么这个问题
- the advantage of — ……的优势
- A number of sociologists — 一些社会学家
...
1. 形容词：Kangaroos' eyesight is also **excellent**.
2. 副词：
	- 程度副词：They have a wide field of vision and, like most grazing animals, they are **especially** good at detecting movement.
3. 数词
	- "The six babies here are all less than six months old. You'll be watching them on closed circuit TV."
4. 动词
	1. 短语动词
5. 连接词
6. 时态
	...
	- **一般过去时** did
		...
		- "Taylor was elected in 1849."
		- "Stieglitz went from the United States to Germany to study engineering."
	- **现在进行时** be doing
		- "We're being videotaped for the local TV stations."
		- "Can you see that their ears are moving?"
	- **现在完成时** have done
		- "Insurance has existed in some forms for a very long time."
		- "A trend has been developing to introduce premium, specially blended coffees."
	- **现在完成进行时** **have been doing**
		...
		- "In recent years, people **have been moving** away from private transportation and toward public transit."
		- "Scientists **have been studying** the migration patterns of birds for decades."
	- ~~**过去完成时**~~
		- ~~"If the balloon had been made of a stronger material, the flight might have lasted longer."~~
	- **将来时** will do, be going to do
		- "We'll be testing the hypothesis that babies can count as early as five months of age."
		- "Our master thatchers will begin giving this barn a sturdy thatched roof."
7. **被动语态**
...
8. **倒装句**：**Located at the NASA Research Center in Iowa is** a 5,000-gallon vat of water.
9. 疑问句： Can you see that their ears are moving? 
10.  **强调句**
	- **It is/was ... that ...**：**It was** in Boston **that** the trend of gourmet coffees first began.
11. 虚拟语气：
	1. **与现在事实相反**：**If he were** alive today, he would be amazed at how much we've learned about the universe.
	2. **与过去事实相反**：**If the balloon had been made of a stronger material**, the flight might have lasted longer.
12. 比较句
	- **as ... as ...**：Many grains are as simple to cook as spaghetti.
	- **be -er than**：So, air pressure inside is greater than air pressure outside.
13. 非谓语动词：不要局限于以下固定的句型，事实上可以以恰当的形式出现在任务位置。
	- **to do**
		- 动词+ to do：However, she refused to back down and leave the army. Today I want to focus on human language and how it developed.
		- 形容词 + to do：
			- 主动：
			- 被动：You'll find that grains are easy to prepare.
			- it：
		- 系动词 be + to do，to可以省略：I decided that the best way to assess the need for expanded hours was to talk to the people who were still in the student center at closing time.
	- **doing 动名词**
		- 作介词宾语，短语动词：Everyone is interested in improving their diet.
		- 作主语：Adding grains is one of the easiest ways.
		- 状语的介词的宾语：But in general they could get along just fine by relying on themselves, not on commercial ties with others.
			- Rather than taking more hops to increase speed, the kangaroo makes the length of each jump longer. 后面+doing
	- **doing/done 现在/过去分词**
		- 状语
		- 定语
		- **过去分词作定语**：The **assigned** chapter on insurance should have been read before class.
		-  "The Everglades is a watery plain covered with saw grass."
14. **并列结构**
	- and：
	- **not only ... but also ...**：Jefferson was **not only** a president **but also** a great reader and language enthusiast.
15. 从句
	- **名词性从句**
		- **同位语从句**，在名词后： There's some reliable evidence that language began with early humans a million and a half years ago.
		- **主语从句**： What's interesting about them is that scientists don't actually know exactly why tornadoes occur. 也是表语从句
		- **表语从句**：The result is that the building explodes outward. My recommendation is that we ask the administration to keep the center open after midnight for studying.
			- **This is because ...**：This is possible because when a tornado passes over a house, it sucks up air from around the house and so the air pressure outside the house drops rapidly.
			- The main reason he was chosen as a candidate was **that he was a war hero.**
		- **宾语从句**，
			- 短语动词的介词+宾语从句：Next, we'll talk a little bit about how new technological developments are being used to try to predict tornadoes.
			- We need to decide **whether** we should plant trees along the main road or in the park.
	- **状语从句**
		- **时间状语从句**：
			- 句首：Before we move on, I'd like to point out one more thing. 
			- 句尾：We encourage all students to volunteer for at least one community activity **before they graduate.**
		- **条件状语从句**：If you look closely, you can see a joey, that's a baby kangaroo, peering out of its mother's pouch.
			- **If there are no questions**, let's turn to Chapter One now.
		- **原因状语从句（because）**：This is a good place to start **because it's home to many of the plants and animals** typically associated with the Everglades.
		- **让步状语从句（even though/although）**：**Although** the ballet was first performed in 1981, it remains popular today.
	- **定语从句**
		- that/which/who引导的限制性定语从句**：A new community program called "One On One" helps elementary students **who've fallen behind.**
		- **where引导的定语从句**：We'll stop first at Taylor Slough, **where you can see many of the plants and animals typically associated with the Everglades.**
		- **which引导的非限制性定语从句**：The Everglades is a watery plain covered with saw grass, **which is home to numerous species of plants and wildlife.**
	- **从句嵌套**，也可以看出往后续：
		- Even though she had two medical degrees, many officers made her life difficult because they didn't believe that a woman should be a doctor. 状语从句里面有宾语从句。
		- I doubt you'll be surprised when I say that the evolution of language was slow and laborious. 状语从句里面有宾语从句。
		- This should meet the objection that it costs too much to staff the center from midnight to eight a.m., which I'm sure will be the first response. 定语从句+宾语从句
		- Theexperiment is based on the well-established observation that babies stare longer if they don't see what they expect to see. 同位语+状语+宾语从句
		- **When most of you imagine an astronaut**, that's probably the first thing that comes to mind. 状语+定语从句
...
1. 从哪里拿到时间戳
每篇听力在 KMF 网站上有对应的「精听练习」页面，比如第一篇：


https://toeflv3.kmf.com/listening/drilling/271m3k.html
页面 HTML 里藏了一个 JavaScript 变量 playList，包含每句话的起止时间：


var playList = [{
  "audio": {"name": "partC-01.mp3", "audio_time": "72.00"},
  "sentence": [
    {"content": "Community service is an important...", "start_time": "0.6", "audio_time": "4.80"},
    {"content": "We encourage all students to...", "start_time": "5.4", "audio_time": "6.30"},
    // ... 每句话都有 start_time 和 audio_time
  ]
}];
93 篇的 question ID（271m3k 那串）从你的笔记文件里的原文链接提取。

2. 怎么算累积时间
关键挑战：每句话的 start_time 是篇内偏移，要变成整组合集里的绝对时间。做法：


累积偏移 = 前面所有篇的真实时长之和 + 前面的间隙之和

SRT 绝对时间 = 累积偏移 + 当前句的 start_time
3. 对齐的三轮修正
版本	做法	偏差
v1	用网站上报的 audio_time（整数秒）当篇长	+62s — 网站整数比实际 MP3 少了约 0.6~1s/篇，93 篇累积漂移
v2	用 ffprobe 实测每篇 MP3 真实时长	+5.9s — 间隙按整数 2000ms 算，但 MP3 帧对齐后实际是 2064ms
v3	间隙用精确值 2064ms	0.018s — 和合并后的 MP3 几乎完美对齐
最终 1353 条字幕，最后一条结束在 02:18:55,968，文件总长 02:18:56,64，余下 0.7 秒是末篇的自然尾音。
...
1. 自然科学（共17篇） 地质9篇、环境/生态/气象/天文8篇 
2. 社会科学（共28篇） 交通运输6篇、教育/经济/商业6篇、历史10篇、人类/社会3篇、心理/语言3篇 
3. 生命科学（共18篇） 动物/植物4篇、生物行为/生物原理9篇、医学5篇 
4. 文化艺术（共21篇） 建筑5篇、美术/摄影/手工7篇、书刊杂志/文学4篇、舞蹈/艺术史5篇 
5. 校园生活（共9篇） 生活相关5篇、学习相关4篇 
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/271m3k.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/1065qh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/151m5k.html
...
### 06. Twyla Tharp's Rock Ballet

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/461m6k.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/5525th.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/251m7k.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/ba75vh.html

Now that we've all introduced ourselves to the new members, let's get down to work. As the committee in charge of this year's tree-planting project, we have several items on our agenda. First, we have to review the budget. The president has informed me that the trustees have set aside $3,000 for the purchase of trees, and our environmental T-shirt sale netted a profit of $15,00. Second, we have to finalize the choice of trees. As you know, we're working with Richardson's Nursery again this year since everyone seemed pleased with the work he did for us last year. Mr Richardson has presented us with several choices within our price range that he thinks would meet our needs. He sent us pictures of the trees for us to look at, but he wanted me to tell you that we're welcome to visit the nursery if we want to see the trees themselves. Lastly, we need to plan some kind of ceremony to commemorate the planting. Several ideas, including a garden party of some sort, have been suggested. So let's get on with it and turn to the first order of business.

---

### 10. Thatching

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/041m8k.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/97e5xh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/1745yh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/37d5zh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/101m9k.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/03a63h.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/ea564h.html
...
### 19. Workbook Introduction

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/f31mbk.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/32966h.html
...
### 21. Private Transportation

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/dd1mck.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/371mdk.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/14b69h.html
...
### 24. The Painter Grant Wood

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/7106ah.html
...
### 25. Pattern Books For Building Hosuse

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/d106bh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/0306ch.html
...
### 29. Prehistoric People Of the Nevada Desert

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/681mfk.html
...
### 32. Career In Airline

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/871mhk.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/af86jh.html
...
### 36. Children Interaction

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/88d6mh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/2e06nh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/f41mik.html

I'd like to begin by thanking Dr Kane for inviting me to be here today. Although I'm not a geologist, I have been collecting minerals for years. My collection is really diverse because I've traveled all over the world to find them. Today I've brought a few specimens for you to see. After I discuss each one, I'll pass it around so that you can look at it more closely. As you know, feldspars are the most abundant minerals and are divided into a number of types. These first samples are orthoclases. Notice that they vary in color from white to pink to red. This glassy one is found in volcanic rock. In fact, I found it in New Mexico on a collecting trip. This next sample that I'll pass around is a microcline mineral, also called amazonstone. You can identify it by its bright green color. It's often used in jewelry and really is quite attractive. These final samples are all plagioclase feldspars. Many plagioclases are very rare, so I'm particularly proud of the variety in my collection. I've also brought a few slides of some larger mineral samples. And if you'll turn out the lights now, I'd like to show them to you.

---

### 39. Yellowstone

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/701mjk.html
...
### 40. Housing For Next Year

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/731mkk.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/7fa6rh.html
...
### 42. Workplace Technology

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/a716sh.html
...
### 43. Watches And Clocks

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/93c6th.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/071mlk.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/35e6vh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/22d6wh.html
...
### 47. Ceramics Workshop

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/c3c6xh.html

We've been together now in this pottery class for several weeks, and I feel you are all doing very well. I thought you might be interested in hearing about a ceramics workshop that will be held here at the college next month. Kate Ferguson, who was recently named by Ceramics Monthly as one of the dozen best potters in the world, will be at the recreation center for an intensive seven-day workshop. Participants in the workshop will, Kate has assured me, make a lot of pots and be able to work closely with her on refining their techniques and skills. There's only room for eighteen potters and advanced pottery students in the workshop, so everyone will get personal attention. It costs $175, which includes all your materials, and a picnic, which is usually attended by all of the participants at the end of the workshop. A $50 deposit is required ahead of time, with the rest of the tuition due by may fifteenth. I should mention that this workshop is cosponsored by the Van Howe Chemical Company, which is donating the clay. If you want to register for the workshop you should call the recreation center at 5553080. You should really consider taking advantage of this opportunity.

---

### 48. Hypersomniacs

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/3246yh.html
...
### 49. Recalculate The Elevation Of Mt. Everest

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/261mmk.html

Not long ago, some of you may have read about a team of mountain-climbing scientists, who helped to recalculate the elevation of the highest mountain in the world: Mount Everest. Of course, the elevation of Mount Everest was determined many years ago, using traditional surveying methods. But these scientists wanted to make a more precise measurement using a new method that takes advantage of recent advances in technology. It's called the Global Positioning System. The Global Positioning System uses 24 satellites that circle the Earth. Each of these satellites is constantly sending out signals. And each signal contains important information that can be used to determine the longitude, latitude, and elevation of any point on the Earth's surface. Well, in order to use this system to calculate Mount Everest's elevation, scientists needed to put a special receiver on its summit to receive signals from the satellites. The problem with this was that, in the past, the receivers were much too heavy for climbers to carry. But now these receivers have been reduced to about the size and weight of a handheld telephone, so climbers were able to take a receiver to the top of Everest. And from there, to access the satellite system signals that would allow them to determine the precise elevation. And it turns out that the famous peak is actually a few feet higher than was previously thought.

---

### 50. Mouse

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/7cb70h.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/d2d73h.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/241mok.html

Well, if there are no more questions I would like to continue our discussion of human evolution by looking at Homo erectus, the earliest of our ancestors who stood upright. Homo erectus lived about one and a half million years ago and was given that name because, at the time the first fossil was discovered, it represented the first primate to stand upright. There is evidence now that Homo erectus had sharper mental skills than their predecessors. They constructed the first standardized tool for hunting and butchering. They created an extraordinary stone implement, a large teardrop-shaped hand ax whose design and symmetry reveal a keen sense of aesthetics. This detailing, along with the ax's utilitarian value, strongly suggest that Homo erectus had the ability to conceive of and execute a design to specification. In addition, Homo erectus was the first hominid to use fire. This discovery enticed them to cook meat, which they could flavor and keep from spilling by flame, and which paleontologists now believe may have given them a new disease. Some fossil bones of Homo erectus are grossly deformed. And paleontologists have noted that this condition is similar to that found in people today, who have been exposed to chronic overdoses of vitamin A. Apparently Homo erectus first got this disease by eating large amounts of animal liver.

---

### 55. The Short Story

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/d0975h.html
...
### 56. The Sediment On The Ocean Floor

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/fbd76h.html
...
### 59. The Old Canada Road

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/f01mrk.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/dfb7ah.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/651msk.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/121mtk.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/6f1muk.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/6c1mxk.html
...
### 67. The Women's Studies Program

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/a81myk.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/931mzk.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/8d27jh.html

Today, I'd like to turn our attention to an area of management often overlooked in traditional management courses: small-business management. Small businesses have gone from being traditional small-town stores selling food or clothing to sophisticated, high-tech enterprises. And in addition to the important products they produce, they create jobs for lots of people because there are so many of them. It's important for management to keep in mind which of the customers' needs the business serves, because it can't serve all their needs. Writing a business plan that everyone in the organization understands and follows will help to provide the necessary focus and direction. It's important to state clearly what the purpose of the business is. Additionally, each person within the organization must know what tasks to perform in order to fulfill that purpose. Now, if for some reason a business plan doesn't work, try hard to discover why not, rewrite it, and immediately focus on the new plan. A word of caution, however, never give up a bad plan without replacing it. A business has to have a plan because it can't afford to waste its limited resources. And, as you know, waste leads to unnecessarily high production costs. Production costs are at the heart of the company's ability to make a high quality product and sell it at an affordable price.

---

### 70. Shaker Furniture Design

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/c567kh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/b51n0k.html
...
### 72. Cariboo Gold Rush

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/1a1n1k.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/e71n2k.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/f71n3k.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/821n4k.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/a437sh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/231n5k.html
...
### 80. The Ten Kilometer Run

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/3747uh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/6a1n6k.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/4567wh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/8a17xh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/74a7yh.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/8897zh.html
...
### 86. Opening Hours Of The Student Center

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/f11n7k.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/811n8k.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/97782h.html
...
### 89. Eastern Woodland Indian

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/fe983h.html
...
### 90. Migration Patterns Of Birds

> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/68d84h.html
...
> 原文链接：https://toeflv3.kmf.com/question/kaomanfen/2f1n9k.html
